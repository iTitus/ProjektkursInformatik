...
public class GuiStartGame extends Gui implements IButtonListener {
    ...
    public void initGui() {
        ...
        super.initGui();
        addElement(new Button(Integers.WINDOW_HUD_X, Integers.WINDOW_HUD_Y, 0, this, "button.backToMainMenu"));
        ...
        for (int i = 0; i < list.size(); i++) {
            addElement(new Button(Integers.WINDOW_HUD_X + i % j * Integers.DEFAULT_BUTTON_WIDTH, Integers.WINDOW_HUD_Y + (i / j + 1) * Integers.DEFAULT_BUTTON_HEIGHT, i + 1, this, list.get(i).getName()));
        }
    }
