...
public abstract class Element implements IHasPositionAndSize<Integer, Integer>, IUpdatable, IGuiTooltipProvider {
	 ...
	 *
	 * @param posX X-Koordinate des Punkts
	 * @param posY Y-Koordinate des Punkts
	 * @return true, wenn ja; false, wenn nein
	 */
	 ...
	 *
	 * @param x X-Bildschirmkoordinate
	 * @param y Y-Bildschirmkoordinate
	 * @param e MouseEvent
	 */
