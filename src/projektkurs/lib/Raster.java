...
public final class Raster {
    ...
    public static AbstractRaster frauV_N;
    public static AbstractRaster frauV_E;
    public static AbstractRaster frauV_S;
    public static AbstractRaster frauV_W;
    public static AbstractRaster guy0_N;
    public static AbstractRaster guy0_E;
    public static AbstractRaster guy0_S;
    public static AbstractRaster guy0_W;
    public static AbstractRaster women0_N;
    public static AbstractRaster women0_E;
    public static AbstractRaster women0_S;
    public static AbstractRaster women0_W;
    public static AbstractRaster ferry;
    public static AbstractRaster car_empty_N;
    public static AbstractRaster car_empty_E;
    public static AbstractRaster car_empty_S;
    public static AbstractRaster car_empty_W;
    public static AbstractRaster car_lord_N;
    public static AbstractRaster car_lord_E;
    public static AbstractRaster car_lord_S;
    public static AbstractRaster car_lord_W;
    public static AbstractRaster car_lord_frauV_N;
    public static AbstractRaster car_lord_frauV_E;
    public static AbstractRaster car_lord_frauV_S;
    public static AbstractRaster car_lord_frauV_W;
    public static AbstractRaster fisherboat;
