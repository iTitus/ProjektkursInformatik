...
public final class Dialoge {
    ...
    public static void init() {
        ...
        LVmFaehrmann = new Dialog("LVmFaehrmann", new DialogPart("LVmFaehrmannNull", 1, 0, 2).setEndAction(ReflectionUtil.getMethod(Scripts.class, "cutscenetwo")));
        ...
        LVmFrau = new Dialog("LVmFrau", new DialogPart("LVmFrauNull", 0b100, 1, 2), new DialogPart("LVmFrauEins", 0b1000, 1, 2), new DialogPart("LVmFrauZwei", 1 << 4, 1, 2), new DialogPart("LVmFrauDrei", 1 << 5, 1, 1));
        ...
        LVmHexerzirkelOne = new Dialog("LVmHexerzirkelOne", new DialogPart("LVmHexerzirkelOneNull", 1 << 17, 1 << 12 | 1 << 13 | 1 << 14, 1));
