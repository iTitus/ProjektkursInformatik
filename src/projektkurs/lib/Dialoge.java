...
public final class Dialoge {
    ...
    public static void init() {
    	...
    	LVmFrauOne = new Dialog("LVmFrauOne", new DialogPart("LVmFrauOneNull",(1<<2),((1<<0)|(1<<1)),3), new DialogPart("LVmFrauOneEins",(1<<3),((1<<0)|(1<<1)),2), new DialogPart("LVmFrauOneZwei",(1<<4),((1<<0)|(1<<1)),2), new DialogPart("LVmFrauOneDrei",(1<<5),((1<<0)|(1<<1)),1).setEndAction(ReflectionUtil.getMethod(Scripts.class, "cutscenetwo")));
    	...
    	LVmFischerNull = new Dialog("LVmFischerNull", new DialogPart("LVmFischerNullnull",(1<<6),((1<<2)|(1<<3)|(1<<4)|(1<<5)),6), new DialogPart("LVmFischerNullEins",(1<<7),((1<<2)|(1<<3)|(1<<4)|(1<<5)),5), new DialogPart("LVmFischerNullZwei", (1<<8),((1<<2)|(1<<3)|(1<<4)|(1<<5)),5), new DialogPart("LVmFischerNullDrei", (1<<9),((1<<2)|(1<<3)|(1<<4)|(1<<5)),2), new DialogPart("LVmFischerNullVier", (1<<10),((1<<2)|(1<<3)|(1<<4)|(1<<5)),2), new DialogPart("LVmFischerNullFuenf", (1<<11),((1<<2)|(1<<3)|(1<<4)|(1<<5)),1));
    	registerMapping(LVmFischerNull);
    	
    	LVmHexerzirkelNull = new Dialog("LVmHexerzirkelNull", new DialogPart("LVmHexerzirkelNullnull",(1<<12),((1<<6)|(1<<7)|(1<<8)|(1<<9)|(1<<10)|(1<<11)),2), new DialogPart("LVmHexerzirkelNullEins",(1<<13),((1<<6)|(1<<7)|(1<<8)|(1<<9)|(1<<10)|(1<<11)),4), new DialogPart("LVmHexerzirkelNullZwei",(1<<14),((1<<6)|(1<<7)|(1<<8)|(1<<9)|(1<<10)|(1<<11)),7));
