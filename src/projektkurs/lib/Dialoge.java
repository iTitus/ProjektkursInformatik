...
public final class Dialoge {
    ...
    public static void init() {
        ...
        LVmJungeAmWegesrandOne = new Dialog("JungeAmWegesrandOne", new DialogPart("JungeAmWegesrandOneEins", 1 << 16, 1 << 13 | 1 << 12 | 1 << 14, 6).setEndAction(ReflectionUtil.getMethod(Scripts.class,"spawnItemRemoveItem", Integer.TYPE, Integer.TYPE, ItemStack.class, Integer.TYPE), 32, 51, new ItemStack(Items.stoneCatapult, 1, 100), 10));
        ...
        LVmHexerzirkelTwo = new Dialog("LVmHexerzirkelTwo", new DialogPart("LVmHexerzirkelTwo", 1 << 18, 1 << 15 | 1 << 16 | 1 << 17, 1).setEndAction(ReflectionUtil.getMethod(Scripts.class,"spawnItemRemoveItem", Integer.TYPE, Integer.TYPE, ItemStack.class, Integer.TYPE), 46, 47, new ItemStack(Items.gramophoneItem), 19));
        ...
        // Gleichzusetzten mit neccValue von Hexerzirkel, da DialogValue Sich im Laufe verändert // Testweise, da VilleCar sich auf Stumm gestellt hat
        ...
        /*
        LVmStein = new Dialog("LVmStein", new DialogPart("LVmSteinNull",0,0,1));
        registerMapping(LVmStein);
        
        LVmTeddy = new Dialog("LVmTeddy", new DialogPart("LVmTeddyNull",0,0,1));
        registerMapping(LVmTeddy);
        
        LVmYoyo = new Dialog("LVmYoyo", new DialogPart("LVmYoyoNull",0,0,1));
        registerMapping(LVmYoyo);
        
        LVmKaugummi = new Dialog("LVmKaugummi", new DialogPart("LVmKaugummiNull",0,0,1));
        registerMapping(LVmKaugummi);
        
        LVmNetz = new Dialog("LVmNetz", new DialogPart("LVmNetzNull",0,0,1));
        registerMapping(LVmNetz);
        
        LVmMesser = new Dialog("LVmMesser", new DialogPart("LVmMesserNull",0,0,1));
        registerMapping(LVmMesser);
        */
