...
public class DialogPart implements Iterable<String> {
	 ...
	 * @param talkLength Laenge des weiterfuehrenden Gespraechs
	 */
	 ...
	 *
	 * @param name           Anzeigename
	 * @param valueChange    Wertaenderung
	 * @param necessaryValue benoetigter Wert
	 * @param talkLength     Laenge des weiterfuehrenden Gespraechs
	 */
	 ...
	 *
	 * @param activated true, wenn er aktivert werden soll; false, wenn er deaktiviert werden soll
	 */
