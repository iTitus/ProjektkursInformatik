...
public final class ReflectionUtil {
	 ...
	 *
	 * @param packageName Name des Packages
	 * @return alle Klassen
	 */
	 ...
	 *
	 * @param dir         zu durchsuchender Ordner
	 * @param packageName Name des Packages
	 * @return alle Klassen
	 */
	 ...
	 *
	 * @param jarOrZipFile JAR oder ZIP Datei
	 * @param packageName  Name des Packages
	 * @return alle Klassen
	 */
	 ...
	 *
	 * @param cls             Klasse
	 * @param annotationClass Annotations-Klasse
	 ...
	 *
	 * @param classes         zu durchsuchende Klassen
	 * @param annotationClass Annotations-Klasse
	 * @param modifiers       alle Modifiers
	 * @return Methoden
	 */
	 ...
	 *
	 * @param <T>  der erwartete Rueckgabetyp
	 * @param m    Methode
	 * @param args Parameter
	 ...
	 * @param <T>  Typ der Klasse
	 * @param cls  Klasse
	 * @param args Konstruktorargumente
	 * @return Instanz
	 */
	 ...
	 *
	 * @param first       ob dies der erste Methoden-Aufruf ist - sollte true sein
	 * @param fileOrDir   zu duchsuchender Ordner oder Datei
	 * @param packageName Name des Packages
	 * @param classes     alle Klassen
	 */
