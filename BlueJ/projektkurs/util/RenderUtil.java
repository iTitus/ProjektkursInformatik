...
public final class RenderUtil {
	 ...
	 * @param endX   X-Koordinate
	 * @param endY   Y-Koordinate
	 */
	 ...
	 *
	 * @param screen Screen
	 * @param startX X-Koordinate A
	 * @param startY Y-Koordinate A
	 * @param endX   X-Koordinate B
	 * @param endY   Y-Koordinate B
	 * @param color  Farbe
	 */
