...
public final class Integers {
     ...
     */
    public static int       sightX                 = Toolkit.getDefaultToolkit().getScreenSize().width / Integers.RASTER_SIZE - 2 * Integers.WINDOW_HUD_X
                                                           / Integers.RASTER_SIZE;
    /**
     * Höhe des Sichtfeldes in Rastern.
     */
    public static int       sightY                 = Toolkit.getDefaultToolkit().getScreenSize().height / Integers.RASTER_SIZE - 2 * Integers.WINDOW_HUD_Y
